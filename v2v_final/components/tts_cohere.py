...
#     print('pplx streaming called:',datetime.now())
#     global stop_playing
        ...
        if event.event_type == "stream-end":
            ...
            try:
                ...
                if json_start != -1:
                    ...
                    print(jsonResponse)
                    play_audio = False
                    await handle_gpt_response(json_string, play_audio)
                else:
...
# # Function to handle chat with user and then play response as audio
# async def ask_question(chat_history, query, output_filename, preamble):
#     print('ask question called:',datetime.now())
#     chat_history = await cohere_response(chat_history, query, output_filename, preamble)
#     print('ask question completed:',datetime.now())
