...
def ask_question(chat_user_info, chat_history, query, ask_question_prompt, output_filename):
    ...
    chat_history = asyncio.run(pplx_streaming(chat_user_info, chat_history, query, output_filename))
...
if __name__ == "__main__":
    ...
    ask_question(args.chat_user_info, args.chat_history, args.query, args.ask_question_prompt, args.output_filename)
