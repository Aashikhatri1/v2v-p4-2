...
async def process_transcription_data(name):
    ...
    # await print_and_save(f'|User| {query} | ', output_filename)
    ...
    try: 
        ...
        # has_end_convo = any('EndConvo' in value for value in category.values())
        # if has_end_convo:
        ...
        #         pg.mouseDown()
        #         asyncio.sleep(0.1)  # Short delay to simulate a real click
        #         pg.mouseUp()
        #     else:
