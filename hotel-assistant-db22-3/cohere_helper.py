...
preamble=""
co = cohere.Client('BCSZlsuipHi1lim22uOAMTo0zakQOgMzLSa95Rym')
...
# preamble=""". Please act as a hotel receptionist for 365 ai tech. Start with "Hi , how can i assist you".
...
def call_chat_bot(message, chat_history):
  # Define the endpoint URL
  endpoint_url = 'https://api.npoint.io/8267b2142d4b9095d4c9'
  # Make a GET request
  play_filler()
#   music_thread = threading.Thread(target=play_filler)
#   music_thread.start()
  ...
  if response.status_code == 200:
      ...
      preamble = f"{instructions} <json>{json_string}</json>"
      if preamble:   
